...
%%% @doc A CRDT object handler. It defines the operations to be
%%%      applied to AQL columns that are represented as CRDT objects.
%%% @end
%%%-------------------------------------------------------------------
...
%% ===================================================================
%% CRDT Bounded counter functions
%% ===================================================================
