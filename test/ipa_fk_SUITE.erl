...
reference_deleted_fail(_Config) ->
  {ok, [], _Tx} = tutils:delete_by_key("FkA", "1"),
  {ok, [{error, Msg1}], _} = tutils:aql("INSERT INTO FkB VALUES (2, 1)"),
  {ok, [{error, Msg2}], _} = tutils:aql("INSERT INTO FkC VALUES (1, 1)"),
